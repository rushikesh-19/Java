...
<html>
<head>
<title>ViewContactUs-BookWorld</title>
...
<tbody>
  <tr>
    <th scope="row"><%=rs.getInt("contact_id") %></th>
    <td><%=rs.getString("user_name") %></td>
    <td><%=rs.getString("email") %></td>
	<td><%=rs.getString("contact") %></td>    
	<td><%=rs.getString("message") %></td>
  	<td><a class="btn btn-danger" href='deletequries.jsp?contact_id=<%=rs.getInt("contact_id")%>'>Delete</a></td>
  </tr>
</tbody>
