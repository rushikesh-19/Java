...
<html>
<head>
<title>ContactUs-BookWorld</title>
...
<div class="card text-center container col-sm-4 mt-5">
	<div class="card-body">
		...
		<h1 class="card-title">ContactUs</h1>
		<input class="form-control mb-1" type="text" name="user_name" placeholder="Enter your name" required="required">
		<input class="form-control mb-2" type="email" name="email" placeholder="Enter your email address" required="required">
		<input class="form-control mb-1" type="text" name="contact" placeholder="Enter your contact no" required="required">
