...
<html>
<head>
<title>ViewFeedback-BookWorld</title>
...
<tbody>
	<tr>
    	<th scope="row"><%=rs.getInt("feedback_id") %></th>
    	<td><%=rs.getString("user_name") %></td>
    	<td><%=rs.getString("email") %></td>
		<td><%=rs.getString("contact") %></td>    
		<td><%=rs.getString("message") %></td>
  		<td><a class="btn btn-danger" href='deletefeedback.jsp?feedback_id=<%=rs.getInt("feedback_id")%>'>Delete</a></td>
	</tr>
</tbody>
