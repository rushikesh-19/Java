...
<html>
<head>
<title>ViewOrder-BookDetails</title>
...
String query = "select * from saveorder";
...
<tbody>
	<tr>
    	<th scope="row"><%=rs.getInt("order_id") %></th>
		...
		<td><%=rs.getString("contact") %></td>
  		<td><a class="btn btn-danger" href='deleteorder.jsp?order_id=<%=rs.getInt("order_id")%>'>Delete</a></td>
  </tr>
</tbody>
